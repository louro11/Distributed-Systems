...
public class MediatorEndpointManager {
	...
	public void start() throws Exception {
		...
		System.out.println(wsName + "---" + wsURL);
		String wsid = wsURL.replaceFirst("^http://localhost:807", "");
		wsid = wsid.substring(0, 1);
		if(wsid.equals("1")) {
			publishToUDDI();
			System.out.println(wsName + " at " + wsURL + "working as primary mediator");
		} else
			System.out.println(wsName + " at " + wsURL + "working as secundary mediator");
	}
