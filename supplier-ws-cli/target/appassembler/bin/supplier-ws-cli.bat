...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="supplier-ws-cli" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" org.komparator.supplier.ws.cli.SupplierClientApp %CMD_LINE_ARGS%
